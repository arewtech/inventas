                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted d-block mt-1">Setiap aset adalah 1 unit individual</small>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('asset-maintenances.edit', $asset->asset_number) }}"
                                    class="btn btn-primary">
                                    <i class="ti ti-edit me-1"></i> Edit Aset
                                </a>
                                <form action="{{ route('asset-maintenances.destroy', $asset->asset_number) }}"
