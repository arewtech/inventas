@extends('layouts.app', ['title' => 'List Surat Keterangan Aktif Mengajar'])
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
            <div class="mb-3 mb-sm-0">
                <h5 class="card-title fw-semibold">Data Surat Keterangan Aktif Mengajar</h5>
                <p class="card-subtitle mb-0">List Surat Keterangan Aktif Mengajar yang telah dibuat</p>
            </div>
        ...
        <div class="card w-100">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
                        ...
                        <tbody class="border-top">
                            @forelse ($active_teachings as $item)
                                <tr>
                                    <td>
                                        <p class="mb-0">
                                            {{ $loop->iteration + ($active_teachings->currentPage() - 1) * $active_teachings->perPage() }}
                                        </p>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        {{ $item->birth_place }}, {{ formatDate($item->birth_date) }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <form action="{{ route('active-teachings.update', $item->id) }}" method="post">
                                            @csrf
                                            @method('put')
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
                                                ...
                                                <li>
                                                    <form onsubmit="return confirm('Apakah anda yakin?')"
                                                        action="{{ route('active-teachings.destroy', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header d-flex align-items-center">
                                                        <h4 class="modal-title" id="myModalLabel">
                                                            Detail Surat Keterangan Aktif Mengajar
                                                        </h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        @if ($item->number !== null && $item->status === 'approved')
                                                            <div class="d-flex align-items-center gap-1">
                                                                ...
                                                                <a href="{{ route('active-teachings.print', $item->id) }}"
                                                        ...
                                                        <table class="table table-bordered mt-3">
                                                            ...
                                                            <tr>
                                                                <td class="text-muted fw-semibold"> Nama Guru :</td>
                                                                <td class="text-capitalize"> {{ $item->teacher_name }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted fw-semibold"> NUPTK :</td>
                                                                <td> {{ $item->nuptk }} </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted fw-semibold"> Jumlah Jam Mengajar :
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted fw-semibold"> TMT :</td>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5 text-capitalize"
                                                            ...
                                                            Update Nomor Surat | {{ $item->teacher_name }}
                                                        </h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <form
                                                        action="{{ route('active-teachings.update-number', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('put')
                                                        <div class="modal-body">
                ...
                <div class='px-4 mt-3'>{{ $active_teachings->links() }}</div>
            </div>
        </div>
    </div>
@endsection
