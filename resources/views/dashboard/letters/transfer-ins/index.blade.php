@extends('layouts.app', ['title' => 'List Surat Keterangan Mutasi Terima'])
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
            <div class="mb-3 mb-sm-0">
                <h5 class="card-title fw-semibold">Data Surat Keterangan Mutasi Terima</h5>
                <p class="card-subtitle mb-0">List Surat Keterangan Mutasi Terima yang telah dibuat</p>
            </div>
        ...
        <div class="card w-100">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
                        ...
                        <tbody class="border-top">
                            @forelse ($transfer_ins as $item)
                                <tr>
                                    <td>
                                        <p class="mb-0">
                                            {{ $loop->iteration + ($transfer_ins->currentPage() - 1) * $transfer_ins->perPage() }}
                                        </p>
                                    </td>
                                    <td>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
                                                ...
                                                <li>
                                                    <form onsubmit="return confirm('Apakah anda yakin?')"
                                                        action="{{ route('transfer-ins.destroy', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header d-flex align-items-center">
                                                        <h4 class="modal-title" id="myModalLabel">
                                                            Detail Surat Keterangan Mutasi Terima
                                                        </h4>
                                        ...
                                        <div class="modal fade" id="modal-update-{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('transfer-ins.update-number', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('put')
                                                        <div class="modal-body">
                ...
                <div class='px-4 mt-3'>{{ $transfer_ins->links() }}</div>
            </div>
        </div>
    </div>
@endsection
