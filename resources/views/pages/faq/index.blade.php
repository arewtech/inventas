                ...
                <div class="accordion accordion-flush col-md-8 col m-auto my-4" id="accordionFlushExample">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Inventas adalah platform pembuatan surat online untuk sekolah yang dapat
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Apakah Aplikasi Inventas sangat membantu bagi masyarakat?
                            </button>
                        </h2>
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Ya, Aplikasi Inventas sangat membantu bagi masyarakat. Dengan
                                    Inventas, masyarakat dapat membuat surat-surat resmi sekolah
                                    secara online tanpa harus datang langsung ke sekolah. Platform ini
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingThree">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Apakah Aplikasi Inventas tersedia untuk umum?
                            </button>
                        </h2>
                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Ya, Aplikasi Inventas tersedia untuk umum. Siapa saja dapat
                                    mendaftar dan menggunakan layanan pembuatan surat online di Inventas.
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingFour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Bagaimana alur setelah mengisi formulir surat di Inventas?
                            </button>
                        </h2>
                        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Setelah mengisi formulir surat di Inventas, surat Anda akan masuk
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Layanan pembuatan surat di platform Inventas ini khusus diperuntukkan
